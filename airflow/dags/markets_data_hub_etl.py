...
validate_bronze = PythonOperator(
    ...
    python_callable=lambda: print(
        "Running Great Expectations validations on Bronze layer"
    ),
    dag=dag,
)
...
with TaskGroup(
    "silver_transformations", tooltip="Clean and normalize", dag=dag
) as silver_group:
...
validate_silver = PythonOperator(
    ...
    python_callable=lambda: print(
        "Running Great Expectations validations on Silver layer"
    ),
    dag=dag,
)
...
with TaskGroup(
    "gold_risk_analytics", tooltip="Calculate risk metrics", dag=dag
) as gold_group:
...
validate_gold = PythonOperator(
    ...
    python_callable=lambda: print(
        "Running Great Expectations validations on Gold layer"
    ),
    dag=dag,
)
